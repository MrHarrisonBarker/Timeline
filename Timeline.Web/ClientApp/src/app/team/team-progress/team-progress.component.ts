...
export class TeamProgressComponent implements OnInit
{
  ...
  constructor (public teamService: TeamService,public jobService: JobService)
  {
  }
  ...
  ngOnInit (): void
  {
    ...
    this.teamService.team.Jobs.forEach(job =>
    {
      let today = new Date();
  ...
  {
    this.jobsByProgress = this.teamService.team.Jobs.sort((a,b) => {
